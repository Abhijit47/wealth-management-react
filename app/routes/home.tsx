                    ...
                    <div className='col-lg-12'>
                      <div className='choose-single-bx'>
                        <div className='choose-single-thumb'>
                          <img src='/images/main-home/choose_img.jpg' alt='' />
            ...
            <div className='col-lg-8' data-aos='fade-left'>
              <div className='row'>
                <div className='col-lg-6 col-md-6'>
                  <div className='single-service-box'>
                    <div className='service-icon'>
                      <img src='/images/main-home/service-icon01.png' alt='' />
                    </div>
                ...
                <div className='col-lg-6 col-md-6'>
                  <div className='single-service-box'>
                    <div className='service-icon'>
                      <img src='/images/main-home/service-icon02.png' alt='' />
                    </div>
                    <div className='service-content'>
                ...
                <div className='col-lg-6 col-md-6'>
                  <div className='single-service-box'>
                    <div className='service-icon'>
                      <img src='/images/main-home/service-icon03.png' alt='' />
                    </div>
                    <div className='service-content'>
                ...
                <div className='col-lg-6 col-md-6'>
                  <div className='single-service-box'>
                    <div className='service-icon'>
                      <img src='/images/main-home/service-icon04.png' alt='' />
                    </div>
                    <div className='service-content'>
                      <h3>Room Services</h3>
                      <p>
